...
int _tmain(int argc, char* argv[])
{
	...
	char filepath_in[] = "D:/res/800_600.264";
#else
	...
	while (1) {
		...
		while (cur_size > 0) {
			...
			case AV_PICTURE_TYPE_I: printf("Type:I\t"); count_I++; break;
			case AV_PICTURE_TYPE_P: printf("Type:P\t"); count_P++; break;
			case AV_PICTURE_TYPE_B: printf("Type:B\t"); count_B++; break;
